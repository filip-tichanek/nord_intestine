...
author: "Filip Tichanek, Asta Försti, Vaclav Liska, Akseli Hemminki, Kari Hemminki"
...
```{r,errors=FALSE}
prior_group <- c(
  set_prior("normal(0,20)", class = "b", coef = "groupFinland.Males"),
  set_prior("normal(0,20)", class = "b", coef = "groupNorway.Males"),
  set_prior("normal(0,20)", class = "b", coef = "groupSweden.Males"),
  set_prior("normal(0,20)", class = "b", coef = "groupDenmark.Males"),
  set_prior("normal(0,20)", class = "b", coef = "groupNorway.Females"),
  set_prior("normal(0,20)", class = "b", coef = "groupSweden.Females"))
```
...
xx=xx+1
tabce3(cis3_fin_rectum_mal_5y,-0.8)
